#!/usr/bin/env bash
# Runs SonarScanner analysis on the multitier React frontend.
#
...
echo "Running SonarScanner for multitier React frontend..."

npx -y sonarqube-scanner \
    "-Dsonar.projectKey=optivem_shop-multitier-frontend-react" \
    "-Dsonar.projectName=shop-multitier-frontend-react" \
